...
const GovernmentIDs = ({ careWorker }: Props) => {
    return (
        <Card elevate>
            ...
            <Card.Footer p="$4">
                <YStack gap="$3">
                    <DetailRow label="SSS ID Number" value={careWorker.sss_id_number} />
                    <DetailRow label="PhilHealth ID Number" value={careWorker.philhealth_id_number} />
                    <DetailRow label="Pag-Ibig ID Number" value={careWorker.pagibig_id_number} />
                </YStack>
            </Card.Footer>
        </Card>
    );
