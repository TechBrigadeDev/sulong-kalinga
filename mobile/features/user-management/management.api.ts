...
class UserManagementController extends Controller {
    async getBeneficiaries(params?: {
        ...
        const valid =
            await userManagementSchema.getBeneficiaries.safeParseAsync(
                data,
            );
        if (!valid.success) {
            console.error(
                "Beneficiaries validation error",
                valid.error,
            );
            throw new Error(
                "Beneficiaries validation error",
    ...
    async getFamilyMembers(params?: {
        ...
        try {
            ...
            const valid =
                await userManagementSchema.getFamilyMembers.safeParseAsync(
                    data,
                );
            if (!valid.success) {
                console.error(
                    "Family members validation error",
                    valid.error,
                );
                throw new Error(
                    "Family members validation error",
    ...
    async getFamilyMember(id: string) {
        ...
        const valid =
            await userManagementSchema.getFamilyMember.safeParseAsync(
                data,
            );
        if (!valid.success) {
            console.error(
                "Family member validation error",
                valid.error,
            );
            throw new Error(
                "Family member validation error",
    ...
    async getCareWorkers(params?: {
        ...
        const data = await response.data;
        const valid =
            await userManagementSchema.getCareWorkers.safeParseAsync(
                data,
            );
        if (!valid.success) {
            console.error(
                "Care workers validation error",
                valid.error,
            );
            throw new Error(
                "Care workers validation error",
    ...
    async getCareWorker(id: string) {
        ...
        const valid =
            await userManagementSchema.getCareWorker.safeParseAsync(
                data,
            );
        if (!valid.success) {
            console.error(
                "Care worker validation error",
                valid.error,
            );
            throw new Error(
                "Care worker validation error",
    ...
    async getCareManagers(params?: {
        ...
        const valid =
            await userManagementSchema.getCareManagers.safeParseAsync(
                data,
            );
        if (!valid.success) {
            console.error(
                "Care managers validation error",
                valid.error,
            );
            throw new Error(
                "Care managers validation error",
    ...
    async getCareManager(id: string) {
        ...
        const valid =
            await userManagementSchema.getCareManager.safeParseAsync(
                data,
            );
        if (!valid.success) {
            console.error(
                "Care manager validation error",
                valid.error,
            );
            throw new Error(
                "Care manager validation error",
    ...
    async getAdministrators(params?: {
        ...
        const valid =
            await userManagementSchema.getAdministrators.safeParseAsync(
                data,
            );
        if (!valid.success) {
            console.error(
                "Administrators validation error",
                valid.error,
            );
            throw new Error(
                "Administrators validation error",
    ...
    async getAdmin(id: string) {
        ...
        const valid =
            await userManagementSchema.getAdmin.safeParseAsync(
                data,
            );
        if (!valid.success) {
            console.error(
