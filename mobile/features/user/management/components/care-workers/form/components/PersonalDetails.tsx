import { YStack, XStack, Label, Input, Button, Select } from 'tamagui'
  ...
  return (
    <YStack space="$4">
      ...
      <XStack space="$3">
        ...
        <YStack flex={1}>
          <Label htmlFor="lastName" color="$red10">Last Name *</Label>
          <Input
            id="lastName"
      ...
      <XStack space="$3">
        ...
        <YStack flex={1}>
          ...
          <Select
            ...
            onValueChange={(value) => setFormData({ ...formData, educationalBackground: value })}
          >
            <Select.Trigger>
