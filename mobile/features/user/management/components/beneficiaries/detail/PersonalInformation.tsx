...
const PersonalInformation = ({ beneficiary }: Props) => {
    return (
        <Card elevate>
            <Card.Header padded>
                ...
                <YStack gap="$3">
                    <XStack gap="$4">
                        ...
                        <YStack flex={1}>
                            ...
                            <Text>{beneficiary.civil_status}</Text>
                        </YStack>
                    </XStack>
                    <XStack gap="$4">
                        <YStack flex={1}>
                        ...
                        <YStack flex={1}>
                            ...
                            <Text>{new Date(beneficiary.birthday).toLocaleDateString()}</Text>
                        </YStack>
                    </XStack>
                    <YStack>
                        <Text opacity={0.6}>Address</Text>
                        <Text>{beneficiary.street_address}</Text>
                    </YStack>
                    <XStack gap="$4">
                        <YStack flex={1}>
