...
export type OutdoorActivityData = OutdoorActivityIntervention[];

interface OutdoorActivityProps {
    data?: OutdoorActivityData;
    onChange?: (data: OutdoorActivityData) => void;
}
...
interface InterventionItemProps {
    ...
    onChange: (interventions: OutdoorActivityIntervention[]) => void;
}
