...
>[] = [
    {
        name: "Going outside for fresh air and sunlight",
        minutes: "",
    },
    {
        name: "Walking in parks and other areas in the community",
        minutes: "",
    },
    {
        name: "Encourage/Assist in spending time outdoors",
        minutes: "",
    },
...
interface OutdoorActivityProps {
    ...
    onChange: (
        data: Partial<OutdoorActivityData>,
    ) => void;
}
