import { Button, Card, Input, Label, ScrollView, Select, Text, XStack, YStack } from "tamagui";
...
const BENEFICIARIES: Beneficiary[] = [
  { id: "1", name: "Juan Dela Cruz", age: "75", gender: "Male", medicalConditions: "Hypertension, Type 2 Diabetes" },
...
export const PersonalDetails = ({ data, onChange }: PersonalDetailsProps) => {
  const selectedBeneficiary = data.beneficiaryId ? BENEFICIARIES.find(b => b.id === data.beneficiaryId) : undefined;
          ...
          <Card.Footer padded>
            <YStack style={{ gap: 16 }}>
              <Select
                ...
                onValueChange={(value: string) => onChange({ beneficiaryId: value })}
              >
                ...
                <Select.Content>
                  ...
                  <Select.Viewport>
                    {BENEFICIARIES.map((beneficiary, index) => (
                      ...
                      >
                        <Select.ItemText>{beneficiary.name}</Select.ItemText>
                      </Select.Item>
                    ))}
                  </Select.Viewport>
              ...
              {selectedBeneficiary && (
                <YStack gap="$2">
                  ...
                  <Text>Medical Conditions: {selectedBeneficiary.medicalConditions}</Text>
                </YStack>
              )}
            </YStack>
          </Card.Footer>
