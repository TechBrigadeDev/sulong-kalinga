...
const Screen = () => {
    ...
    const shiftDetails = {
        ...
        beneficiaryAddress:
            "66 General Malvar Extension Barrio Jesus Dela Pena 1800, Marikina",
        hoursWorked: {
        ...
        <TabScroll style={{ flex: 1 }}>
            ...
            >
                ...
                <ShiftDetails
                    ...
                    value={
                        shiftDetails.beneficiaryName
                    }
                />
                <ShiftDetails
                    label="Schedule Type"
                    value={
                        shiftDetails.scheduleType
                    }
                />
                <ShiftDetails
                    label="Date"
                ...
                <ShiftDetails
                    ...
                    value={
                        shiftDetails.scheduledTime
                    }
                />
                <ShiftDetails
                    label="Beneficiary Address"
                    value={
                        shiftDetails.beneficiaryAddress
                    }
                />
                ...
                {shiftDetails.movementHistory.map(
                    (movement, index) => (
                        <Card
                            key={index}
                            style={{
