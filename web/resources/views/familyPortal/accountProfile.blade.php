                    ...
                    <div class="profile-sections">
                        ...
                        <div class="profile-section {{ session('activeTab') != 'contact' && session('activeTab') != 'settings' ? 'active' : '' }}" id="personal-section">
                            ...
                            <div class="row">
                                <div class="col-md-4 text-center">
                                    ...
                                    @endif
                                    <h5>{{ $familyMember->first_name }} {{ $familyMember->last_name }}</h5>
                                    <p class="text-muted">Member since: {{ $memberSince }}</p>
                                    <p class="mb-1"><span class="badge bg-info">Family Member</span></p>
                                    <p class="text-muted">{{ $familyMember->relation_to_beneficiary }}</p>
                                </div>
                                <div class="col-md-8">
                                    <div class="row info-row">
                                        <div class="col-md-3 info-label">Full Name:</div>
                                        <div class="col-md-9">{{ $familyMember->first_name }} {{ $familyMember->last_name }}</div>
                                    </div>
                                    <div class="row info-row">
                                    ...
                                    <div class="row info-row">
                                        ...
                                        <div class="col-md-9">{{ $familyMember->gender ?? 'Not specified' }}</div>
                                    </div>
                                    <div class="row info-row">
                                        <div class="col-md-3 info-label">Related To:</div>
                                        <div class="col-md-9">
                                    ...
                                    <div class="row info-row">
                                        ...
                                        <div class="col-md-9">{{ $familyMember->is_primary_caregiver ? 'Yes' : 'No' }}</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="profile-section {{ session('activeTab') == 'contact' ? 'active' : '' }}" id="contact-section">
                            ...
                            <div class="row info-row">
                                ...
                                <div class="col-md-9">{{ $familyMember->email }}</div>
                            </div>
                            <div class="row info-row">
                                <div class="col-md-3 info-label">Mobile Phone:</div>
                                <div class="col-md-9">{{ $familyMember->mobile ?? 'Not specified' }}</div>
                            </div>
                            <div class="row info-row">
                                <div class="col-md-3 info-label">Landline:</div>
                                <div class="col-md-9">{{ $familyMember->landline ?? 'Not specified' }}</div>
                            </div>
                            <div class="row info-row">
                                <div class="col-md-3 info-label">Address:</div>
                                <div class="col-md-9">{{ $familyMember->street_address }}</div>
                            </div>
                        </div>
