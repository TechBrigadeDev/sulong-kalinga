                    ...
                    <div class="viewProfile">
                        <div class="row mb-2">
                            <div class="col-12 text-center">
                                <h4 class="mb-0"><i class="bi bi-person-badge me-2" style="color: var(--complement-1);"></i>{{ T::translate('MY PROFILE', 'IYONG PROFILE')}}</h4>
                            </div>
                        </div>
                            ...
                            <div class="row">
                                <div class="col-md-4 text-center mb-4 mb-md-0">
                                    @if($familyMember->photo)
                                        <img src="{{ asset('storage/' . $familyMember->photo) }}" alt="Profile Photo" class="profile-photo">
                                    @else
                                        <img src="{{ asset('images/defaultProfile.png') }}" alt="Profile Photo" class="profile-photo">
                                    @endif
                                    <h5 class="user-name">{{ $familyMember->first_name }} {{ $familyMember->last_name }}</h5>
                                    ...
                                    <p class="user-role"><i class="bi bi-people me-1"></i>{{ $familyMember->relation_to_beneficiary }}</p>
                                </div>
                                ...
                                <div class="col-md-8">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <div class="info-card">
                                                <div class="info-row">
                                                    ...
                                                    <div class="info-value">{{ $familyMember->first_name }} {{ $familyMember->last_name }}</div>
                                                </div>
                                                <div class="info-row">
                                                ...
                                                <div class="info-row">
                                                    ...
                                                    <div class="info-value">{{ $familyMember->gender ?? 'Not specified' }}</div>
                                                </div>
                                                <div class="info-row">
                                                    <div class="info-label"><i class="bi bi-person-heart"></i>{{ T::translate('Age', 'Edad')}}:</div>
                                                    <div class="info-value">{{ $age ?? 'Not specified' }} years old</div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-md-6">
                                            <div class="info-card">
                                                <div class="info-row">
                                                    <div class="info-label"><i class="bi bi-person-vcard"></i>Related To:</div>
                                                    <div class="info-value">
                                                        {{ $beneficiary->first_name }} {{ $beneficiary->last_name }}
                                                        <span class="text-muted">({{ $familyMember->relation_to_beneficiary }})</span>
                                                    </div>
                                                </div>
                                                <div class="info-row">
                                                    <div class="info-label"><i class="bi bi-heart-pulse"></i>{{ T::translate('Primary Caregiver', 'Pangunahing Tagapag-alaga')}}:</div>
                                                    <div class="info-value">{{ $familyMember->is_primary_caregiver ? 'Yes' : 'No' }}</div>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="info-card">
                                        <div class="info-row">
                                            ...
                                            <div class="info-value">{{ $familyMember->email }}</div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-6">
                                    <div class="info-card">
                                        <div class="info-row">
                                            ...
                                            <div class="info-value">{{ $familyMember->mobile ?? 'Not specified' }}</div>
                                        </div>
                                        <div class="info-row">
                                            <div class="info-label"><i class="bi bi-telephone"></i>Landline:</div>
                                            <div class="info-value">{{ $familyMember->landline ?? 'Not specified' }}</div>
                                        </div>
                                        <div class="info-row">
                                            <div class="info-label"><i class="bi bi-geo-alt"></i>{{ T::translate('Address', 'Tirahan')}}:</div>
                                            <div class="info-value">{{ $familyMember->street_address }}</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="profile-section {{ session('activeTab') == 'settings' ? 'active' : '' }}" id="settings-section" style="display: none;">
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="info-card">
                                        ...
                                        <div class="info-row">
                                            <div class="info-label"><i class="bi bi-shield-check"></i>{{ T::translate('Account Status', 'Stratus ng Account')}}:</div>
                                            <div class="info-value">
                                                <span class="badge badge-status badge-active">
                            ...
                            <div class="form-section" id="updateEmailForm" style="display: none;">
                                ...
                                <form action="{{ route('family.profile.update-email') }}" method="POST">
                                    @csrf
                                    <div class="mb-3">
                                        ...
                                        <input type="email" class="form-control" value="{{ $familyMember->email }}" disabled>
                                    </div>
                                    <div class="mb-3">
                                        <label for="account_email" class="form-label"><i class="bi bi-envelope-plus me-1"></i>{{ T::translate('New Email', 'Bagong Email')}}</label>
                                        <input type="email" class="form-control" id="account_email" name="account_email" placeholder="{{ T::translate('Enter new email address', 'Ilagay ang bagong email')}}" value="{{ old('account_email') }}" required>
                                    </div>
                                    <div class="mb-3">
                                        ...
                                        <div class="input-group">
                                            <input type="password" class="form-control" id="current_password_for_email" name="current_password" placeholder="{{ T::translate('Enter your password to confirm', 'Ilagay ang kasalukuyang password')}}" required>
                            ...
                            <div class="form-section" id="updatePasswordForm" style="display: none;">
                                ...
                                <form action="{{ route('family.profile.update-password') }}" method="POST">
                                    @csrf
                                    <div class="mb-3">
