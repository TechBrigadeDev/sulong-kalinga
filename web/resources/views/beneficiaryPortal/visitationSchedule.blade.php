...
<head>
    ...
    <title>Visitation Schedule | Beneficiary Portal</title>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function loadUpcomingVisits() {
                ...
                $.ajax({
                    url: "{{ secure_url(route('beneficiary.visitation.schedule.upcoming', [], false)) }}", // or beneficiary.visitation.schedule.upcoming
                    type: 'GET',
                    data: {
                        status: statusFilter,
            ...
            const calendar = new FullCalendar.Calendar(calendarEl, {
                ...
                events: function(info, successCallback, failureCallback) {
                    ...
                    $.ajax({
                        url: "{{ secure_url(route('beneficiary.visitation.schedule.events', [], false)) }}",
                        method: 'GET',
                        headers: {
                            'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
                        },
            ...
            function createVisitCard(visit) {
                ...
                viewDetailsBtn.addEventListener('click', function() {
                    ...
                    $.ajax({
                        url: `{{ secure_url('beneficiary/visitation-schedule/details') }}/${visit.occurrence_id}`,
                        type: 'GET',
                        success: function(response) {
                            if (response.success) {
                                const details = response.details;
