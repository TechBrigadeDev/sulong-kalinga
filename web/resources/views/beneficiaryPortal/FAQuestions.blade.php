                    ...
                    <div class="faq-container">
                        ...
                        <div class="faq-card">
                            <div class="faq-question">
                                <span>{{ T::translate('What is the Mobile Healthcare Service (MHCS)?', 'Ano ang Mobile Healthcare Service (MHCS)?') }}</span>
                        ...
                        <div class="faq-card">
                            <div class="faq-question">
                                <span>{{ T::translate('How often will the healthcare workers visit?', 'Gaano kadalas bibisita ang mga healthcare worker?') }}</span>
                                <i class="bi bi-chevron-down faq-icon"></i>
                            </div>
                            <div class="faq-answer">
                        ...
                        <div class="contact-info">
                            ...
                            {{ T::translate('Phone:', 'Telepono:') }} [Insert COSE contact number]<br>
                            {{ T::translate('Email:', 'Email:') }} [Insert COSE email]<br>
