...
<head>
    ...
    <title>Care Plan Records | Beneficiary Portal</title>
                        ...
                        <div class="card-body p-0">
                                                    ...
                                                    <td class="actions-cell">
                                                        @if(!$plan->acknowledged_by_beneficiary && !$plan->acknowledged_by_family)
                                                            <button class="btn btn-sm btn-primary acknowledge-btn" 
                                                                ...
                                                                title="{{ T::translate('Acknowledge', 'Kilalanin')}}">
                                                                {{ T::translate('Acknowledge', 'Kilalanin')}}
                                                            </button>
                                                        @endif
                                                        <a href="{{ route('beneficiary.care.plan.view', $plan->weekly_care_plan_id) }}" 
                                                            class="btn btn-sm btn-info" title="{{ T::translate('View Details', 'Tingnan ang Detalye')}}">
                            ...
                            @else
                                <div class="empty-state p-4 text-center">
                                    ...
                                    <p class="text-muted">{{ T::translate('There are currently no care plan records available', 'Kasalukuyang walang available na talaan ng care plan')}}.</p>
                                </div>
                            @endif
                        </div>
                    </div>
