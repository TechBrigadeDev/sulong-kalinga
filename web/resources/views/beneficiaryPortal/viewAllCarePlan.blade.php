    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function loadCarePlans(page = 1) {
                ...
                fetch(`{{ route('beneficiary.care.plan.index') }}?search=${encodeURIComponent(search)}&filter=${filter}&page=${page}&ajax=1`, {
                    headers: {
                ...
                .then(html => {
                    ...
                    window.history.pushState(
                        ...
                        '',
                        `{{ route('beneficiary.care.plan.index') }}?search=${encodeURIComponent(search)}&filter=${filter}&page=${page}`
                    );
                })
                .catch(error => {
