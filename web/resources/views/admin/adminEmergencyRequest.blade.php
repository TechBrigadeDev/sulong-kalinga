...
<head>
    ...
    <title>Emergency Notices & Service Requests | Admin</title>
...
<body>
    ...
    <script>
        ...
        function viewEmergencyDetails(noticeId) {
            ...
            $.ajax({
                url: "/admin/emergency-request/emergency/" + noticeId,
                method: 'GET',
        ...
        $('#submitEmergencyResponse').on('click', function() {
            ...
            // Submit form
            $.ajax({
                url: "/admin/emergency-request/respond-emergency",
                method: 'POST',
                data: formData,
                processData: false,
                contentType: false,
        ...
        $(document).ready(function() {
            ...
            $('#submitServiceResponse').on('click', function() {
                ...
                // Submit request
                $.ajax({
                    url: "/admin/emergency-request/handle-service",
                    method: 'POST',
                    data: formData,
                    processData: false,
                    contentType: false,
        ...
        function viewServiceRequestDetails(requestId) {
            ...
            $.ajax({
                url: "/admin/emergency-request/service-request/" + requestId,
                method: 'GET',
                success: function(response) {
                    if (response.success) {
        ...
        function loadCareWorkers() {
            $.ajax({
                url: "/admin/emergency-request/care-workers",
                method: 'GET',
                success: function(response) {
        ...
        $('#submitArchiveRecord').on('click', function() {
            ...
            // Submit form
            $.ajax({
                url: "/admin/emergency-request/archive",
                method: 'POST',
                data: formData,
                processData: false,
                contentType: false,
    ...
    <script>
        ...
        function refreshMainContent() {
            ...
            $.get("{{ route('admin.emergency.request.partial-content') }}", function(html) {
