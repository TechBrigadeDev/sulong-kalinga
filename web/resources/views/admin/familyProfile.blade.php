...
<head>
    ...
    <title>Family Profiles | Admin</title>
    ...
    <div class="home-section">
        ...
        <div class="card-container">
            ...
            <form id="exportForm" method="POST" style="display: none;"
                action="/admin/export/family-pdf"
                data-pdf-route="/admin/export/family-pdf" 
                data-excel-route="/admin/export/family-excel">
                @csrf
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="action-icons">
                                        ...
                                        <a href="{{ route('admin.families.edit', $family_member->family_member_id) }}" class="btn btn-link" title="Edit">
