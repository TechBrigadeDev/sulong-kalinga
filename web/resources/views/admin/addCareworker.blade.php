...
<head>
    ...
    <title>Add Care Worker | Admin</title>
    ...
    <div class="home-section">
        <div class="container-fluid">
            <div class="d-flex justify-content-between align-items-center mb-3">
                ...
                <div class="mx-auto text-center" style="flex-grow: 1; font-weight: bold; font-size: 20px;">{{ T::translate('ADD CARE WORKER', 'MAGDAGDAG NG CARE WORKER') }}</div>
            </div>
            @if (session('success'))
            ...
            <div class="row" id="addUserForm">
                <div class="col-12">
                    <form action="{{ route('admin.careworkers.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-3">
                                ...
                                <select class="form-select" id="educationalBackground" name="educational_background">
                                    <option value="" disabled {{ old('educational_background') ? '' : 'selected' }}>{{ T::translate('Select educational background', 'Pimili ng Background') }}</option>
                        ...
                        <div class="row mb-3">
                            <div class="col-md-4">
                                <label for="personalEmail" class="form-label">{{ T::translate('Personal Email Address', 'Personal na Email') }}<label style="color:red;"> * </label></label>
                                <input type="email" class="form-control" id="personalEmail" name="personal_email" 
                                       value="{{ old('personal_email') }}"
                                       placeholder="{{ T::translate('Enter personal email', 'Ilagay ang Email') }}" 
                                       required 
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" class="form-control" id="mobileNumber" name="mobile_number" value="{{ old('mobile_number') }}" placeholder="{{ T::translate('Enter mobile number', 'Ilagay ang numero sa mobile') }}" maxlength="11" required oninput="restrictToNumbers(this)" title="Must be 10 or 11digits.">
                                </div>
                            </div>
                            <div class="col-md-4">
                                <label for="landlineNumber" class="form-label">{{ T::translate('Landline Number', 'Numero sa Landline')}}</label>
                                <input type="text" class="form-control" id="landlineNumber" name="landline_number" value="{{ old('landline_number') }}" placeholder="{{ T::translate('Enter Landline number', 'Ilagay ang numero sa landline') }}" maxlength="10" oninput="restrictToNumbers(this)" title="Must be between 7 and 10 digits.">
                            </div>
                        </div>
                        ...
                        <div class="row mb-1">
                            ...
                            <div class="col-md-4">
                                ...
                                <input type="text" class="form-control" id="philhealthID" name="philhealth_ID" value="{{ old('philhealth_ID') }}" placeholder="{{ T::translate('Enter PhilHealth ID', 'Ilagay ang PhilHealth') }}" maxlength="12" oninput="restrictToNumbers(this)" title="Must be 12 digits.">
                            </div>
                            <div class="col-md-4">
                        ...
                        <div class="row mb-1">
                            <div class="col-12">
                                <h5 class="text-start">{{ T::translate('Care Worker Account Registration', 'Pagrerehistro sa Account ng Tagapag-alaga') }}</h5> <!-- Row Title -->
                            </div>
                        </div>
                        <div class="row mb-1">
                            <div class="col-md-4">
                                <label for="email" class="form-label">{{ T::translate('Work Email Address', 'Email sa Trabaho') }}<label style="color:red;"> * </label></label>
                        ...
                        <div class="row mt-4">
                            ...
                            <div class="col-md-4">
                                <label for="assigned_care_manager" class="form-label">{{ T::translate('Assigned Care Manager', 'Nakatalagang Care Manager') }}<label style="color:red;"> * </label></label>
                                <select class="form-select" id="assigned_care_manager" name="assigned_care_manager" required>
                                    <option value="" disabled selected>{{ T::translate('Select care manager', 'Pumili ng Care Manager') }}</option>
