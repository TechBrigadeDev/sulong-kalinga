    ...
    <div class="home-section">
        ...
        <div class="container-fluid text-center">
            ...
            <div class="row mb-3 align-items-center">
                ...
                <!-- Add Report Button -->
                <div class="col-6 col-md-3 col-lg-2 mb-2">
                    <a href="{{ route('admin.careworkers.create') }}">
                    <button class="btn btn-primary w-100" id="addButton" style="padding:6px;">
                        <i class="bi bi-plus"></i> Add Careworker
                    </button>
                    </a>
                </div>
            </div>
                                ...
                                @foreach ($careworkers as $careworker)
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{ route('admin.careworkers.edit', ['id' => $careworker->id]) }}" class="btn btn-link ps-2" style="color:black;">
