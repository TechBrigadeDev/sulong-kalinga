                            ...
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb mb-0">
                                    <li class="breadcrumb-item {{ session('activeTab') != 'contact' && session('activeTab') != 'settings' ? 'active' : '' }}" data-section="personal">
                                        <a href="javascript:void(0)"><i class="bi bi-person-vcard me-1"></i>{{ T::translate('Personal Details','Personal na Detalye')}}</a>
                                    </li>
                                    <li class="breadcrumb-item {{ session('activeTab') == 'contact' ? 'active' : '' }}" data-section="contact">
                                        <a href="javascript:void(0)"><i class="bi bi-telephone me-1"></i>{{ T::translate('Contact','Mga Contact')}}</a>
                                    </li>
                        ...
                        <div class="profile-section {{ session('activeTab') != 'contact' && session('activeTab') != 'settings' ? 'active' : '' }}" id="personal-section">
                            <div class="row">
                                <div class="col-md-4 text-center mb-4 mb-md-0">
                                    ...
                                    <p class="member-since"><i class="bi bi-calendar-event me-1"></i>Miyembro magmula: {{ $memberSince }}</p>
                                    <p class="mb-2">
                        ...
                        <div class="profile-section {{ session('activeTab') == 'settings' ? 'active' : '' }}" id="settings-section" style="display: none;">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="info-card">
                                        <div class="info-row">
                                            <div class="info-label"><i class="bi bi-credit-card"></i>{{ T::translate('SSS ID Number','Numero sa SSS ID')}}:</div>
                                            <div class="info-value">{{ $user->sss_id_number ?? 'Not specified' }}</div>
                                        </div>
                                        <div class="info-row">
                                            <div class="info-label"><i class="bi bi-heart-pulse"></i>{{ T::translate('PhilHealth ID Number','Numero sa PhilHealth ID')}}:</div>
                                            <div class="info-value">{{ $user->philhealth_id_number ?? 'Not specified' }}</div>
                                        </div>
                                        <div class="info-row">
                                            <div class="info-label"><i class="bi bi-house"></i>{{ T::translate('Pag-IBIG ID Number','Numero sa Pag-IBIG ID')}}:</div>
                            ...
                            <div class="form-section" id="updatePasswordForm" style="display: none;">
                                ...
                                <form action="/admin/update-password" method="POST">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="input-group">
                                            <input type="password" class="form-control" id="account_password_confirmation" name="account_password_confirmation" placeholder="{{ T::translate('Confirm new password','Kumpirmahin ang baging password')}}" required>
