@php
    ...
    $isMessagingView = Request::is('*/messaging') || 
                      ...
                      Request::routeIs('family.messaging.*');
@endphp
...
<div class="sidebar {{ $isMessagingView ? 'messaging-sidebar' : '' }}">
  ...
  <ul class="nav-links">
    <li class="{{ Request::routeIs('family.dashboard') ? 'active' : '' }}">
      <a href="{{ route('family.dashboard') }}" @if($isMessagingView) target="_top" onclick="window.top.location.href='{{ route('family.dashboard') }}'; return false;" @endif>
        <i class="bi bi-house-door"></i>
        <span class="link_name">Home</span>
      </a>
      <ul class="sub-menu blank">
        <li><a class="link_name" href="{{ route('family.dashboard') }}" @if($isMessagingView) target="_top" onclick="window.top.location.href='{{ route('family.dashboard') }}'; return false;" @endif>Home</a></li>
      </ul>
    </li>

    <li class="{{ Request::routeIs('family.visitation.schedule.*') ? 'active' : '' }}">
      <a href="{{ route('family.visitation.schedule.index') }}" @if($isMessagingView) target="_top" onclick="window.top.location.href='{{ route('family.visitation.schedule.index') }}'; return false;" @endif>
        <i class="bi bi-calendar-check"></i>
        <span class="link_name">{{ T::translate('Visitation Schedule', 'Iskedyul ng Pagbisita')}}</span>
      </a>
      <ul class="sub-menu blank">
        <li><a class="link_name" href="{{ route('family.visitation.schedule.index') }}" @if($isMessagingView) target="_top" onclick="window.top.location.href='{{ route('family.visitation.schedule.index') }}'; return false;" @endif>Visitation Schedule</a></li>
      </ul>
    </li>
    ...
    <li class="{{ Request::routeIs('family.emergency.service.*') ? 'active' : '' }}">
      <a href="{{ route('family.emergency.service.index') }}" @if($isMessagingView) target="_top" onclick="window.top.location.href='{{ route('family.emergency.service.index') }}'; return false;" @endif>
        <i class="bi bi-clipboard2-pulse"></i>
        <span class="link_name">{{ T::translate('Emergency & Service Requests', 'Emergency at Pakiusap na Serbisyo')}}</span>
      </a>
      <ul class="sub-menu blank">
        <li><a class="link_name" href="{{ route('family.emergency.service.index') }}" @if($isMessagingView) target="_top" onclick="window.top.location.href='{{ route('family.emergency.service.index') }}'; return false;" @endif>Emergency & Service Requests</a></li>
      </ul>
    </li>

    <li class="{{ Request::routeIs('family.care.plan.*') ? 'active' : '' }}">
      <a href="{{ route('family.care.plan.index') }}" @if($isMessagingView) target="_top" onclick="window.top.location.href='{{ route('family.care.plan.index') }}'; return false;" @endif>
        <i class="bi bi-clipboard2-check"></i>
        <span class="link_name">Care Plan</span>
      </a>
      <ul class="sub-menu blank">
        <li><a class="link_name" href="{{ route('family.care.plan.index') }}" @if($isMessagingView) target="_top" onclick="window.top.location.href='{{ route('family.care.plan.index') }}'; return false;" @endif>Care Plan</a></li>
      </ul>
    </li>

    <li class="{{ Request::routeIs('family.faQuestions.*') ? 'active' : '' }}">
      <a href="{{ route('family.faQuestions.index') }}" @if($isMessagingView) target="_top" onclick="window.top.location.href='{{ route('family.faQuestions.index') }}'; return false;" @endif>
        <i class="bi bi-question-square"></i>
        <span class="link_name">Frequently Asked Question</span>
      </a>
      <ul class="sub-menu blank">
        <li><a class="link_name" href="{{ route('family.faQuestions.index') }}" @if($isMessagingView) target="_top" onclick="window.top.location.href='{{ route('family.faQuestions.index') }}'; return false;" @endif>Frequently Asked Question</a></li>
      </ul>
    </li>
    
    <!-- <li class="{{ Request::routeIs('family.messaging.*') ? 'active' : '' }}">
      <a href="{{ route('family.messaging.index') }}" @if($isMessagingView) target="_top" onclick="window.top.location.href='{{ route('family.messaging.index') }}'; return false;" @endif>
        <i class="bi bi-chat-dots"></i>
        <span class="link_name">Messages</span>
      </a>
      <ul class="sub-menu blank">
        <li><a class="link_name" href="{{ route('family.messaging.index') }}" @if($isMessagingView) target="_top" onclick="window.top.location.href='{{ route('family.messaging.index') }}'; return false;" @endif>Messages</a></li>
      </ul>
    </li> -->
  </ul>
</div>
