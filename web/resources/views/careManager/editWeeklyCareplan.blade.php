...
<body>
    ...
    @endif
        <h4 class="text-center mt-2">{{ T::translate('EDIT WEEKLY CARE PLAN FORM', 'I-EDIT ANG WEEKLY CARE PLAN')}}</h4>
                                        ...
                                        <div class="validation-error-container alert alert-danger mb-3" style="display: none;"></div>
                                            ...
                                            <div class="row mb-2">
                                                ...
                                                <div class="col-md-3 col-sm-6 position-relative">
                                                    <label for="gender" class="form-label">{{ T::translate('Gender', '')}}</label>
                                            ...
                                            <div class="row mb-2">
                                                ...
                                                <div class="col-md-6 col-sm-12">
                                                    <label for="illness" class="form-label">{{ T::translate('Illness', 'Mga Sakit')}}</label>
                                                    @php
                                                        $illnessesString = '';
                                                    ...
                                                    <small class="form-text text-muted">{{ T::translate('Leave blank if no illness recorded. Separate multiple illnesses with commas.', 'Iwanang blangko kung walang sakit na nai-tala. Paghiwalayin ang maraming sakit gamit ang kuwit.')}}</small>
                                                </div>
                                            </div>
                                            <hr my-4>
                                                ...
                                                <div class="col-lg-6 col-md-6 col-sm-12">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="col-md-6 col-sm-6 position-relative">
                                                            <label for="body_temperature" class="form-label">{{ T::translate('Body Temperature', 'Temperatura na Katawan')}} (°C)</label>
                                                            ...
                                                            <small class="form-text text-muted">{{ T::translate('Enter a number between', 'Maglagay ng numero na nasa pagitan ng')}} 35-42°C</small>
                                        ...
                                        <div class="form-page" id="page{{ $index + 2 }}" 
                                            ...
                                            <div class="card mb-4">
                                                ...
                                                <div class="card-body">
                                                    ...
                                                    <div class="mt-4">
                                                        <h6>Add Custom {{ $category->care_category_name }} {{ T::translate('Intervention', 'Interbensyon')}}</h6>
                                                ...
                                                <div class="col-lg-6 col-md-6 col-sm-12 text-center">
                                                    <div class="row mb-3">
                                                        <div class="col-md-12 col-sm-12">
                                                            ...
                                                            @else
                                                                <small class="form-text text-muted">{{ T::translate('No image currently uploaded. Please select a new image.', 'Walang larawan ang kasalukuyang na-upload. Mangyaring pumili ng bagong larawan.')}}</small>
                                                            @endif
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        bpInput.addEventListener('input', function() {
            ...
            if (!bpRegex.test(this.value) && this.value !== '') {
                ...
                if (!this.nextElementSibling.classList.contains('invalid-feedback')) {
                    ...
                    feedback.textContent = '{{ T::translate('Blood pressure must be in format', 'Ang presyon ng dugo ay dapat nasa pormat na')}} 120/80';
        ...
        document.getElementById('weeklyCarePlanForm').addEventListener('submit', function(e) {
            ...
            if (!bpRegex.test(bloodPressure)) {
                e.preventDefault();
                showValidationError(1,'{{ T::translate('Blood pressure must be in format', 'Ang presyong ng dugo ay dapat nasa pormat na')}} 120/80');
            ...
            if (bodyTemp < 35 || bodyTemp > 42) {
                e.preventDefault();
                showValidationError(1,'{{ T::translate('Body temperature must be between 35°C and 42°C', 'Ang temperatura ng katawan ay dapat nasa pagitan ng 35°C at 42°C')}}');
                goToPage(1);
                return;
            }
            ...
            if (pulseRate < 40 || pulseRate > 200) {
                e.preventDefault();
                showValidationError(1,'{{ T::translate('Pulse rate must be between 40 and 200 bpm', 'Ang bilis ng pulso ay dapat nasa pagitan ng 40 at 200 bpm')}}');
                goToPage(1);
                return;
            }
            ...
            if (respRate < 8 || respRate > 40) {
                e.preventDefault();
                showValidationError(1,'{{ T::translate('Respiratory rate must be between 8 and 40 bpm', 'Ang bilis ng paghinga ay dapat nasa pagitan ng 8 at 40 bpm')}}');
                goToPage(1);
                return;
            }
        });
       ...
       fetch(`/care-manager/weekly-care-plans/beneficiary/${beneficiaryId}`)
        ...
        document.getElementById('weeklyCarePlanForm').addEventListener('submit', function(e) {
            ...
            if (!assessment) {
                ...
                errors.push('{{ T::translate('Assessment must be at least 20 characters', 'Dapat hindi bababa sa 20 karakter ang pagtatasa')}}');
                isValid = false;
                pageToShow = 1;
            } else if (!/[a-zA-Z]/.test(assessment)) {
                errors.push('{{ T::translate('Assessment must contain text and cannot consist of only numbers or symbols', 'Ang pagtatasa ay dapat maglaman ng teksto at hindi maaaring binubuo lamang ng mga numero o simbolo')}}');
                isValid = false;
                pageToShow = 1;
            }
            ...
            if (!bloodPressure) {
                errors.push('{{ T::translate('Blood pressure is required', 'Ang presyon ng dugo ay kinakailangan')}}');
                isValid = false;
                pageToShow = 1;
            } else {
                const bpRegex = /^\d{2,3}\/\d{2,3}$/;
                if (!bpRegex.test(bloodPressure)) {
                    errors.push('{{ T::translate('Blood pressure must be in format', 'Ang presyon ng dugo ay dapat nasa pormat na')}} 120/80');
                    isValid = false;
                    pageToShow = 1;
                }
            }
            ...
            // Validate pulse rate
            if (!pulseRate) {
                errors.push('{{ T::translate('Pulse rate is required', 'Ang bilis ng pulso ay kinakailangan')}}');
                isValid = false;
                pageToShow = 1;
            } else if (pulseRate < 40 || pulseRate > 200) {
                errors.push('{{ T::translate('Pulse rate must be between 40 and 200 bpm', 'Ang bilis ng pulso ay dapat nasa pagitan ng 40 at 200 bom')}}');
                isValid = false;
                pageToShow = 1;
            }
            ...
            if (!respRate) {
                ...
                errors.push('{{ T::translate('Respiratory rate must be between 8 and 40 bpm', 'Ang bilis ng paghinga ay dapat nasa pagitan ng 8 at 40 bpm')}}');
                isValid = false;
                pageToShow = 1;
            }
            ...
            if (checkedInterventions.length === 0 && !hasCustomInterventions) {
                errors.push('{{ T::translate('Please select at least one intervention', 'Mangyaring pumili ng kahit na isang interbensyon')}}');
                isValid = false;
                pageToShow = 2;
            }
            ...
            checkedInterventions.forEach(checkbox => {
                ...
                if (!durationInput.value) {
                    errors.push('{{ T::translate('Please enter duration for all selected interventions', 'Mangyaring ilagay ang oras para sa lahat ng napiling interbensyon')}}');
                    isValid = false;
                    ...
                    errors.push('{{ T::translate('Duration must be greater than', 'Ang oras ay dapat higit sa')}} 0');
                    isValid = false;
            ...
            document.querySelectorAll('.custom-intervention-row').forEach(row => {
                ...
                if (descriptionInput && descriptionInput.value.trim() !== '') {
                    ...
                    if (descriptionInput.value.trim().length < 5) {
                        errors.push('{{ T::translate('', '')}}{{ T::translate('Custom intervention description must be at least 5 characters', 'Ang paglalarawan ng custom na interbensyon ay dapat na hindi bababa sa 5 character')}}');
                        isValid = false;
                    ...
                    if (!/[a-zA-Z]/.test(descriptionInput.value)) {
                        errors.push('{{ T::translate('Custom intervention description must contain text', 'Ang paglalarawan ng custom na interbensyon ay dapat maglaman ng teksto')}}');
                        isValid = false;
                    ...
                    // Check duration
                    if (!durationInput.value) {
                        errors.push('{{ T::translate('Please enter duration for all custom interventions', 'Mangyaring maglagay ng oras para sa lahat ng custom na interbensyon')}}');
                        isValid = false;
                        ...
                        errors.push('{{ T::translate('Duration for custom interventions must be greater than', 'Ang oras para sa custom na interbensyon ay dapat hihigit sa')}} 0');
                        isValid = false;
            ...
            if (page9 && page9.classList.contains('active')) {
                if (!evaluationRecs) {
                    errors.push('{{ T::translate('Please provide evaluation recommendations', 'Mangyaring magbigay ng rekomendasyon')}}');
                    isValid = false;
                    pageToShow = 9;
                    ...
                    errors.push('{{ T::translate('Evaluation recommendations must contain text and cannot consist of only numbers or symbols', 'Ang mga rekomendasyon sa ebalwasyon ay dapat maglaman ng teksto at hindi maaaring binubuo lamang ng mga numero o simbolo')}}');
                    isValid = false;
                    pageToShow = 9;
                }
            }
    ...
    function deleteOthersInput(containerId) {
        ...
        if (othersRows.length > 1) { // Ensure at least one "Others" input remains
            ...
            showValidationError(pageNum, "{{ T::translate('At least one \'Others\' input is required.', 'Kinakailangan ang kahit isang input na \'Iba\'')}}");
        }
    }
    ...
    function showValidationError(pageNumber, errorMessages) {
        ...
        if (errorContainer) {
            ...
            header.textContent = '{{ T::translate('Please fix the following errors', 'Pakiayos ang mga sumusunod na error')}}:';
