...
<head>
    ...
    <title>Add Family | Manager</title>
    ...
    <div class="home-section">
        <div class="container-fluid">
            ...
            <div class="row" id="addUserForm">
                <div class="col-12">
                    <form action="{{ route('care-manager.families.store') }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                            <div class="col-md-12">
                                <label for="addressDetails" class="form-label">{{ T::translate('House No., Street, Subdivision, Barangay, City, Province', 'Numero ng Bahay, Kalye, Subdivision, Siyudad, Probinsya')}}<label style="color:red;"> * </label></label>
            ...
            if (this.files.length > 0) {
                ...
                if (file.size > MAX_FILE_SIZE) {
                    ...
                    fileSizeErrorMessage.innerHTML = `
                        ...
                        Ma{{ T::translate('Maximum allowed size is', 'Ang maximum na pinapayagang laki ay')}} 7MB.<br>
                        {{ T::translate('Please select a smaller file or compress your existing file.', 'Mangyaring pumili ng mas maliit na file o i-compress ang iyong umiiral na file.')}}
                    `;
                    fileSizeErrorModal.show();
