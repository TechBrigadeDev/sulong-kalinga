...
<head>
    ...
    <title>Records Management | Manager</title>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="action-icons">
                                                ...
                                                <a href="{{ route('care-manager.weeklycareplans.show', $report->report_id) }}" title="{{ T::translate('View Weekly Care Plan', 'Tingnan ang Weekly Care Plan') }}">
                                                    <i class="bi bi-eye"></i>
                                                </a>
                                                <a href="{{ route('care-manager.weeklycareplans.edit', $report->report_id) }}" title="{{ T::translate('Edit Weekly Care Plan', 'I-edit ang Weekly Care Plan') }}">
