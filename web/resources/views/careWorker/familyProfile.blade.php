    ...
    <div class="home-section">
        ...
        <div class="container-fluid text-center">
            ...
            <div class="row mb-3 align-items-center">
                ...
                <div class="col-6 col-md-3 col-lg-3 mb-2">
                    <a href="{{ route('care-worker.families.create') }}">
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="action-icons">
                                                ...
                                                <a href="{{ route('care-worker.families.edit', $family_member->family_member_id) }}" class="btn btn-link text-decoration-none" style="color:black;">
