...
<head>
    ...
    <title>Add Beneificiary | Care Worker</title>
...
<body>
        ...
        <div class="container-fluid">
            ...
            <div class="row" id="addUserForm">
                <div class="col-12">
                    ...
                    @endif
                    <form action="{{ route('care-worker.beneficiaries.store') }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        ...
                        <div class="row mb-3">
                            <div class="col-md-6">
                                <label for="mapLocation" class="form-label">{{ T::translate('Pinpoint in Google Maps', 'Ituro sa Google Maps')}}<label style="color:red;"> * </label></label>
                       ...
                       <!-- Medication Management -->
                        ...
                        <div class="row mb-1">
                            ...
                            <div class="col-md-4">
                                <h5 class="text-start">{{ T::translate('Cognitive Function', 'Kognitibong Pag-andar')}}</h5>
                                <div class="mb-1">
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="mb-1">
                                    ...
                                    <textarea class="form-control" id="mood" name="emotional[mood]" 
                                            placeholder="{{ T::translate('Enter details about mood', 'Ilagay ang detalye sa Kalooban')}}" rows="2" 
                                            pattern="^[A-Za-z0-9\s.,\-()'\"+’!?]+$"!?]+$" 
                                ...
                                <div class="mb-1">
                                    ...
                                    <textarea class="form-control" id="socialInteractions" name="emotional[social_interactions]" 
                                            placeholder="{{ T::translate('Enter details about social interactions', 'Ilagay ang detalye sa Pakikipag-ugnayan sa Lipunan')}}" rows="2" 
                                            pattern="^[A-Za-z0-9\s.,\-()'\"+’!?]+$"!?]+$" 
                        ...
                        <div class="row mb-3">
                            <!-- Email -->
                            <div class="col-md-4">
                                <label for="generatedUsername" class="form-label">{{ T::translate('Username (Auto-generated)', 'Username (Awtomatikong Binuo)')}}</label>
                                <div class="input-group">
                                    ...
                                    <span class="input-group-text"><i class="bi bi-info-circle" title="{{ T::translate('Username is automatically generated from your name: first initial + middle initial + last name', 'Ang Username ay awtomatikong bubuo mula sa iyong pangalan: unang inisyal + gitnang inisyal + apelyido')}}"></i></span>
                                </div>
    ...
    <script>
        ...
        function addTask(taskValue = '') {
            ...
            input.title = "{{ T::translate('Only letters, numbers, spaces, commas, periods, and hyphens are allowed.', 'Tanging mga letra, numero, espasyo, kuwit, tuldok, at gitling lamang ang pinapayagan.')}}";
            ...
            if (input.files.length > 0) {
                ...
                if (file.size > maxSize) {
                    ...
                    fileSizeErrorMessage.innerHTML = `
                        ...
                        ${input.previousElementSibling.textContent} (${fileSizeMB}MB) {{ T::translate('exceeds the maximum size of', 'lumampas sa maximum na laki na')}} ${maxSizeMB}MB.<br>
