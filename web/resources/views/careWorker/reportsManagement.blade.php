...
<head>
    ...
    <title>Records Management | Care Worker</title>
                            ...
                            <div class="filter-row">
                                ...
                                <div>
                                    <button type="button" class="btn btn-outline-secondary w-100 d-flex align-items-center justify-content-center" id="sortToggle" 
                                        ...
                                        <span class="d-sm-inline">{{ ($sortOrder ?? 'asc') == 'desc' ? 'Newest First' : 'Oldest First'}}</span>
                                    </button>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="action-icons">
                                                ...
                                                <a href="{{ route('care-worker.weeklycareplans.show', $report->report_id) }}" title="{{ T::translate('View Weekly Care Plan', 'Tingnan ang Weekly Care Plan') }}">
                                                    <i class="bi bi-eye"></i>
                                                </a>
                                                <a href="{{ route('care-worker.weeklycareplans.edit', $report->report_id) }}" title="{{ T::translate('Edit Weekly Care Plan', 'I-edit ang Weekly Care Plan') }}">
