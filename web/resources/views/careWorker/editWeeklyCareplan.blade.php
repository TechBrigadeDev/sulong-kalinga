...
<head>
    ...
    <title>Edit Weekly Care Plan | Care Worker</title>
...
<body>
            ...
            <div class="container-fluid">
                <div class="row mb-1" id="weeklyCareplanForm">
                    <div class="col-12">
                        ...
                        <form id="weeklyCarePlanForm" action="{{ route('care-worker.weeklycareplans.update', $weeklyCarePlan->weekly_care_plan_id) }}" method="POST" enctype="multipart/form-data" novalidate>
                            @csrf
                            @method('PUT')
                            <div class="row">
                                <div class="col-12">
    ...
    <script>
        ...
        document.getElementById('beneficiary_id').addEventListener('change', function() {
            ...
            fetch(`/care-worker/weekly-care-plans/beneficiary/${beneficiaryId}`)
                .then(response => {
                    if (!response.ok) {
