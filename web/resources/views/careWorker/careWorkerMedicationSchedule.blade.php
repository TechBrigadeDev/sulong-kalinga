        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <form action="{{ route('care-worker.medication.schedule.store') }}" method="POST" id="addScheduleForm">
                        @csrf
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function fetchMedicationSchedule(id) {
                fetch(`{{ route('care-worker.medication.schedule.edit', ':id') }}`.replace(':id', id))
                    .then(response => {
                        if (!response.ok) {
            ...
            function populateEditForm(data, id) {
                ...
                document.getElementById('editScheduleForm').action = `{{ route('care-worker.medication.schedule.update', '') }}/${id}`;
