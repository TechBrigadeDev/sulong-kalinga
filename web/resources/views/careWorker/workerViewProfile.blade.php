                        ...
                        <div class="profile-section {{ session('activeTab') != 'contact' && session('activeTab') != 'settings' ? 'active' : '' }}" id="personal-section">
                            <div class="row">
                                <div class="col-md-4 text-center mb-4 mb-md-0">
                                    ...
                                    <p class="user-role"><i class="bi bi-person-workspace me-1"></i>Care Worker</p>
                                </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    <div class="info-card">
                                        ...
                                        <div class="info-row">
                                            <div class="info-label"><i class="bi bi-geo"></i>Assigned Municipality:</div>
                                            <div class="info-value">{{ $user->municipality->municipality_name ?? 'Not assigned' }}</div>
                                        </div>
                                        <div class="info-row">
                                            <div class="info-label"><i class="bi bi-person-badge"></i>Assigned Care Manager:</div>
