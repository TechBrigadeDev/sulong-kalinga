                ...
                @endif
                    ...
                    <div class="profile-sections">
                        ...
                        <div class="profile-section {{ session('activeTab') != 'contact' && session('activeTab') != 'settings' ? 'active' : '' }}" id="personal-section">
                            ...
                            <div class="row">
                                <div class="col-md-4 text-center">
                                    ...
                                    <p class="text-muted">Care Worker</p>
                                </div>
                                <div class="col-md-8">
                        ...
                        <div class="profile-section {{ session('activeTab') == 'contact' ? 'active' : '' }}" id="contact-section">
                            ...
                            <div class="row info-row">
                                <div class="col-md-3 info-label">Assigned Municipality:</div>
                                <div class="col-md-9">{{ $user->municipality->municipality_name ?? 'Not assigned' }}</div>
                            </div>
                            <div class="row info-row">
                                <div class="col-md-3 info-label">Assigned Care Manager:</div>
                                <div class="col-md-9">
