...
class DatabaseSeeder extends Seeder
{
    ...
    /**
     * Get a custom intervention description based on care category
     */
    private function getCustomInterventionDescription($careCategoryId)
    {
        $customInterventions = [
            1 => [ // Mobility category
                'Personalized transfer assistance with extra support for weak side',
                'Supervised walking with arm support technique adapted for client needs',
                'Modified stair climbing assistance with two-point contact method',
                'Assisted bathroom mobility using specialized adaptive equipment',
                'Customized bed mobility exercises with enhanced lumbar support positioning',
                'Wheelchair transfer training with safety protocols for client-specific needs'
            ],
            2 => [ // Cognitive assistance category
                'Memory enhancement through personalized photo albums and familiar objects',
                'Specialized orientation techniques using client\'s preferred cultural references',
                'Custom cognitive stimulation through familiar local music and conversation topics',
                'Simplified multi-step task instructions with visual aids tailored to client',
                'Personalized reality orientation through daily calendar and local news review',
                'Memory games using client\'s personal interests and hobbies'
            ],
            3 => [ // Personal care category
                'Specialized bathing technique adapted for client\'s mobility limitations',
                'Adaptive dressing method using modified clothing suitable for client',
                'Custom grooming routine with specialized tools for client comfort',
                'Modified oral hygiene protocol for sensitive gums and dental conditions',
                'Personalized skincare regimen for pressure ulcer prevention in high-risk areas',
                'Adapted hair care routine considering client\'s cultural preferences'
            ],
            4 => [ // Medical care category
                'Enhanced medication organization system with color coding for client safety',
                'Specialized wound care technique with minimal discomfort approach',
                'Custom vital signs monitoring with simplified recording method for client',
                'Adaptive range of motion exercises tailored to client\'s specific limitations',
                'Personalized pain management combining physical therapy and comfort measures',
                'Blood pressure monitoring with specialized technique for client comfort'
            ],
            5 => [ // Social activities category
                'Customized reminiscence therapy using local cultural references and memories',
                'Adapted social engagement activities with limited verbal requirements',
                'Modified group activities with enhanced sensory components for client',
                'Personalized community connection through virtual platforms and technology',
                'Specialized family engagement activities focusing on non-verbal communication',
                'Cultural celebration participation adapted to client\'s traditions'
            ],
            6 => [ // Recreation activities category
                'Outdoor activities adapted to client\'s mobility and energy levels',
                'Indoor recreation programs tailored to client\'s interests and abilities',
                'Sensory stimulation activities using client\'s preferred textures and sounds',
                'Creative activities modified for client\'s fine motor capabilities',
                'Music therapy sessions using client\'s favorite local songs',
                'Gardening activities adapted for limited mobility with raised beds'
            ],
            7 => [ // Household category
                'Specialized laundry management with simplified sorting system for client',
                'Customized home organization focused on fall prevention and accessibility',
                'Modified meal preparation techniques with adaptive equipment for safety',
                'Personalized cleaning routine with ergonomic considerations for client',
                'Adaptive home maintenance schedule with prioritized safety tasks',
                'Kitchen safety modifications tailored to client\'s specific needs'
            ]
        ];
        
        // Default to mobility category if the requested one doesn't exist
        if (!isset($customInterventions[$careCategoryId])) {
            $careCategoryId = 1;
        }
        
        return $this->faker->randomElement($customInterventions[$careCategoryId]);
    }
